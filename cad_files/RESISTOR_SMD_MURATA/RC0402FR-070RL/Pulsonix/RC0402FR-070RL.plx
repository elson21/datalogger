...
//16474716/1836760/2.50/2/3/Resistor
...
(library Library_1
	...
	(symbolDef "RC0402FR-070RL" (originalName "RC0402FR-070RL")
	...
	(compDef "RC0402FR-070RL" (originalName "RC0402FR-070RL") (compHeader (numPins 2) (numParts 1) (refDesPrefix R)
		)
		(compPin "1" (pinName "1") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "2" (pinName "2") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Unknown))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "RC0402FR-070RL"))
		...
		(attr "Mouser Part Number" "603-RC0402FR-070RL")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/YAGEO/RC0402FR-070RL?qs=sxZXDnvRBEhfSy4CZGX2ww%3D%3D")
		(attr "Manufacturer_Name" "YAGEO")
		(attr "Manufacturer_Part_Number" "RC0402FR-070RL")
		(attr "Description" "YAGEO - RC0402FR-070RL - RES, 1A, 0.063W, THICK FILM, 0402")
		(attr "<Hyperlink>" "https://www.arrow.com/en/products/rc0402fr-070rl/yageo?region=europe")
		(attr "<Component Height>" "0.4")
		(attr "<STEP Filename>" "RC0402FR-070RL.stp")
